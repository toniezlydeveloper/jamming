...
{
    public class TextStepHandler : ADialogueStepHandler<TextStep>
    {
        ...
        public TextStepHandler(DialogueReferences references, DialogueSettings settings)
        {
        ...
        protected override void Skip(TextStep step)
        {
            if (!_allowSkip)
            {
                return;
        ...
        protected override IEnumerator Handle(TextStep step)
        {
